const en = {
    ...
    apiKeyNameDesc: 'Key name (for identification)',
    apiKeyExpireTime: 'Expiration (optional, leave blank for no expiry)',
    apiKeyStatus: 'Status',
    apiKeyActive: 'Active',
    apiKeyExpired: 'Expired',
    noApiKeyFound: 'No API keys found',
    apiKeyCreatedTitle: 'API Key Created',
    apiKeyCreatedWarning: 'This key is shown only once. Please copy and save it immediately. You will not be able to view the full key again after closing this dialog.',
    copyAndClose: 'Copy & Close',
    emptyApiKeyName: 'Please enter a key name',
    apiKeyDeleteConfirm: 'Are you sure you want to delete key "{msg}"? API calls using this key will stop working immediately.',
}
