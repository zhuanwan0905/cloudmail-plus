const zh = {
    ...
    apiKeyNameDesc: '密钥名称（用于标识用途）',
    apiKeyExpireTime: '过期时间（可选，留空永不过期）',
    apiKeyStatus: '状态',
    apiKeyActive: '有效',
    apiKeyExpired: '已过期',
    noApiKeyFound: '暂无 API 密钥',
    apiKeyCreatedTitle: '密钥创建成功',
    apiKeyCreatedWarning: '密钥仅在此时展示一次，请立即复制保存，关闭后将无法再次查看完整密钥。',
    copyAndClose: '复制并关闭',
    emptyApiKeyName: '请填写密钥名称',
    apiKeyDeleteConfirm: '确定删除密钥「{msg}」吗？删除后使用该密钥的 API 调用将立即失效。',
}
export default zh
